...
class CreateEndpointConnectorRequest(DaraModel):
    def __init__(
        ...
        endpoint: str = None,
        headers: List[main_models.CreateEndpointConnectorRequestHeaders] = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('headers') is not None:
            for k1 in m.get('headers'):
                temp_model = main_models.CreateEndpointConnectorRequestHeaders()
...
class CreateEndpointConnectorRequestHeaders(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
