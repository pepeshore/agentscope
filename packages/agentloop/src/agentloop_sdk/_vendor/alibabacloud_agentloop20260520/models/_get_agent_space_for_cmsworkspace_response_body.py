...
class GetAgentSpaceForCMSWorkspaceResponseBody(DaraModel):
    def __init__(
        self,
        ...
        mse_namespace: main_models.GetAgentSpaceForCMSWorkspaceResponseBodyMseNamespace = None,
        quota: main_models.GetAgentSpaceForCMSWorkspaceResponseBodyQuota = None,
        region_id: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mseNamespace') is not None:
            temp_model = main_models.GetAgentSpaceForCMSWorkspaceResponseBodyMseNamespace()
            self.mse_namespace = temp_model.from_map(m.get('mseNamespace'))

        if m.get('quota') is not None:
            temp_model = main_models.GetAgentSpaceForCMSWorkspaceResponseBodyQuota()
...
class GetAgentSpaceForCMSWorkspaceResponseBodyQuota(DaraModel):
    def __init__(
        self,
...
class GetAgentSpaceForCMSWorkspaceResponseBodyMseNamespace(DaraModel):
    def __init__(
        self,
